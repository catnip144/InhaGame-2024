// 0919_wapi.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY0919WAPI, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY0919WAPI));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY0919WAPI));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY0919WAPI);
...
void FileRead(HWND hWnd, LPCWSTR filename)
{
    HANDLE      hFile;
    LPTSTR      buffer;
    DWORD       size, CharNum;
...
void FileSave(HWND hWnd, LPCWSTR filename)
{
    HANDLE      hFile;
    LPTSTR      buffer;
    int         size;
