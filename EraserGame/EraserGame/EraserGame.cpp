// EraserGame.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "game_control.h"
#include "EraserGame.h"
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
    ...
    LoadStringW(hInstance, IDC_ERASERGAME, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ERASERGAME));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ERASERGAME));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_ERASERGAME);
